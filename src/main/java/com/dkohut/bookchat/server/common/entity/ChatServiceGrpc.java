...
public final class ChatServiceGrpc {
  ...
  public static final String SERVICE_NAME = "com.dkohut.bookchat.server.common.entity.ChatService";

  // Static method descriptors that strictly reflect the proto.
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<com.dkohut.bookchat.server.common.entity.ChatMessage,
      com.dkohut.bookchat.server.common.entity.ChatMessageFromServer> METHOD_CHAT =
      io.grpc.MethodDescriptor.<com.dkohut.bookchat.server.common.entity.ChatMessage, com.dkohut.bookchat.server.common.entity.ChatMessageFromServer>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
          .setFullMethodName(generateFullMethodName(
              "com.dkohut.bookchat.server.common.entity.ChatService", "chat"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.dkohut.bookchat.server.common.entity.ChatMessage.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.dkohut.bookchat.server.common.entity.ChatMessageFromServer.getDefaultInstance()))
          .build();
  ...
  public static abstract class ChatServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<com.dkohut.bookchat.server.common.entity.ChatMessage> chat(
        io.grpc.stub.StreamObserver<com.dkohut.bookchat.server.common.entity.ChatMessageFromServer> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncClientStreamingCall(
              new MethodHandlers<
                com.dkohut.bookchat.server.common.entity.ChatMessage,
                com.dkohut.bookchat.server.common.entity.ChatMessageFromServer>(
                  this, METHODID_CHAT)))
          .build();
    }
  }
  ...
  private static final class ChatServiceDescriptorSupplier implements io.grpc.protobuf.ProtoFileDescriptorSupplier {
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.dkohut.bookchat.server.common.entity.ChatServiceOuterClass.getDescriptor();
    }
  }
